...
def names():
    transferred_from_department = [
        'ВАЛЯВСКИЙ А.А.', 'ЕСЕЕВ Г.Р.', 'БРИЖАТЮК В.В.', 'КРЮЧКО Р.И.', 
        'ОСЬМАКОВ Е.В.', 'ХАБИБУЛИН Р.И.', 'ЯКУШИН Д.А.', 'БОРТНИКОВ П.А.',
        'ХОДЖАВА Л.Р.', 
        'СКВОРЦОВ М.С.', 'АФАНАСЬЕВ А.А.', 'БЕЛЯЕВА Е.В.', 'АХМАДАЛИЕВА Ф.А.',
